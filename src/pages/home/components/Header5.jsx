      ...
      <div className="container relative z-10">
        <div className="flex max-h-[60rem] min-h-svh items-center py-16 md:py-24 lg:py-28">
          <div className="max-w-md">
            ...
            Enjoy an effortless, hassle-free CMDA CDC approval experience with [company name]
            </h1>
            <p className="text-text-alternative md:text-md" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1500">
            While the CMDA CDC approval process can be complex, we make it easier. Our expert team provides guidance and resources that you must easily navigate.
            </p>
