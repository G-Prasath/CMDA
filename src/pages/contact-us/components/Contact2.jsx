      ...
      <div className="container max-w-lg">
        ...
        <form className="grid grid-cols-1 grid-rows-[auto_auto] gap-6">
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            <Label className="mb-3 md:mb-4">Your Role or Interest</Label>
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Client Inquiry" id="#first_choice" />
                <Label htmlFor="#first_choice">Client Inquiry</Label>
              </div>
              <div className="flex items-center space-x-2">
