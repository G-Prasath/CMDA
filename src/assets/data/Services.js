export const NocData = {
    ...
    Testimonials : [
        {
            quote : "I was amazed at how effectively they handled our NOC approval",
            name : "P. Joshi",
            position : "CEO",
        },
        {
            quote : "The NOC clearance was faster than expected, truly professional service.",
            name : "K. Mehta",
            position : "Engineer",
        },
        {
            quote : "The NOC process was hassle-free, handled quickly and effectively.",
            name : "R. Kumar",
            position : "Builder",
        },
    ]
...
export const ClearanceData = {
    ...
    Testimonials : [
        {
            quote : "The CMDA clearance process was quick, smooth, and stress-free!",
            name : "S. Kapoor",
            position : "Architect",
        },
        {
            quote : "Clearance was handled efficiently, allowing our project to move forward.",
            name : "A. rao",
            position : "Developer",
        },
        {
            quote : "Expert guidance made CMDA clearance effortless and completed on time!",
            name : "R. Sharma",
            position : "Builder",
        },
    ]
...
export const ApprovalsData = {
    ...
    Profile : {
        title: "Approvals",
        para: "we master the art of acquiring all the necessary approval for your construction projects, including DTCP, CMDA, corporation, panchayat, and land Approval. Our expert team provides spontaneous services for DTCP and CMDA regularization to ensure compliance with local rules. We also help with RERA registration and make sure your projects meet all legal standards. From documentation to final approval, we simplify the entire process, which ensures timely and effective project initiation. Trust us to manage the approval process, make sure your project is on track. ",
        img: "/Approvals/profile.avif",
    },
    Cards : {
    ...
    Testimonials : [
        {
            quote : "From start to finish, they guided us with professionalism and precision.",
            name : "R.Patel",
            position : "Real Estate Developer",
        },
        {
            quote : "Seamless experience, handled all approvals, allowing focus on project success.",
            name : "M. Khan",
